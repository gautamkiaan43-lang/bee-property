...
INSERT IGNORE INTO `maint_categories` (`name`) VALUES 
('Plumbing'), ('Electrical'), ('AC'), ('General'), ('Painting');

INSERT IGNORE INTO `exp_categories` (`name`) VALUES 
('Repairs'), ('Utilities'), ('Tax'), ('Insurance'), ('Cleaning'), ('Other');

INSERT IGNORE INTO `doc_categories` (`name`) VALUES 
